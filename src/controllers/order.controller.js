...
exports.placeOrder = async (req, res) => {
    ...
    if(paymentMethod==='COD'){
        ...
        try {
            const user = await User.findByPk(userId); // User ki details hasil karein
            const message = `Hi ${user.name},\n\nThank you for your order! Your order #${newOrder.id} has been successfully placed.\n\nTotal Amount: Rs. ${newOrder.total_amount}\n\nWe will notify you once your order is shipped.\n\nThanks,\nThe E-Pharmacy Team`;
            ...
            console.error("Order confirmation email bhejne mein error aayi:", emailError);
        }
        // ===
...
exports.requestReturn = async (req, res) => {
    try {
        ...
        // (Optional) Yahan Admin ko email bhej sakte hain ke "Nayi return request aayi hai"
